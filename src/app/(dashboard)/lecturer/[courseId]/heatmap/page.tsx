...
export default function HeatmapActivityPage({ params }: { params: Promise<{ courseId: string }> }) {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] w-full overflow-hidden bg-background">
      <div className="relative p-6 max-w-[1400px] mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 relative z-10">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground font-medium">Bản đồ nhiệt độ theo dõi tiến độ cày Story Points và Nợ Kỹ thuật (Bug Rate) của sinh viên lớp {courseId}</p>
          </div>
