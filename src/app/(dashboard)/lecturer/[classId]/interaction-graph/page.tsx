...
const nodes = [
  { id: "1", name: "Minh Nguyễn", size: 60, x: 50, y: 30, color: "bg-indigo-500", interactions: 45, role: "Core Member" },
  { id: "2", name: "Linh Trần", size: 45, x: 25, y: 60, color: "bg-teal-500", interactions: 28, role: "Member" },
  { id: "3", name: "An Lê", size: 75, x: 45, y: 70, color: "bg-indigo-500", interactions: 62, role: "Core Member" },
  { id: "4", name: "Huy Hoàng", size: 50, x: 75, y: 55, color: "bg-pink-500", interactions: 35, role: "Member" },
  { id: "5", name: "Thúc Nguyễn", size: 40, x: 65, y: 85, color: "bg-amber-500", interactions: 15, role: "Ghosting Warning" },
  { id: "6", name: "Tuấn Lê", size: 55, x: 20, y: 30, color: "bg-red-500", interactions: 40, role: "Toxic Warning" },
  { id: "7", name: "Phương Ngô", size: 35, x: 80, y: 25, color: "bg-teal-500", interactions: 12, role: "Member" },
];
