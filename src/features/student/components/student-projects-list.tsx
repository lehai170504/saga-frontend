...
import { FolderKanban, Crown, Plus, Loader2, Settings, Users, Activity, AlertTriangle, FileText, Code, Palette, AlertCircle, ChevronDown, ChevronUp, Clock, TrendingUp, Zap } from "lucide-react";
      ...
      <div className="relative p-6 max-w-[1400px] mx-auto space-y-6 ">
        ...
        {isLoading ? (
          ...
          <Tabs defaultValue="overview" className="w-full space-y-6">
            ...
            {/* Tab 3: AI Agent */}
            {projectId && (
              <TabsContent value="ai" className="focus-visible:outline-none space-y-6 mt-0">
