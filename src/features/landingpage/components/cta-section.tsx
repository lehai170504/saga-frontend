  ...
  return (
    <section className="py-32 px-6 max-w-6xl mx-auto text-center">
      ...
      >
        ...
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-primary/40 blur-[100px] rounded-full pointer-events-none group-bg-primary/60 transition-colors duration-700" />
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-primary/30 blur-[100px] rounded-full pointer-events-none group-bg-primary/50 transition-colors duration-700" />
        
        <h2 className="text-4xl md:text-6xl font-bold text-background mb-8 relative z-10 tracking-tight leading-tight">
