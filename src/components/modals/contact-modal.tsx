        ...
        <div className="grid grid-cols-1 md:grid-cols-5">
          ...
          <div className="md:col-span-2 bg-muted/30 p-8 pr-14 md:pr-8 border-b md:border-b-0 md:border-r border-border flex flex-col justify-center">
            <DialogHeader className="mb-8 p-0 text-left">
              <DialogTitle className="text-2xl font-bold mb-2">Liên hệ Hỗ trợ</DialogTitle>
              <DialogDescription>
            ...
            <div className="space-y-6 text-muted-foreground font-medium">
              <div className="flex items-center gap-4 group">
                <div className="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center text-primary group-bg-primary group-hover:text-white transition-colors">
              ...
              <div className="flex items-center gap-4 group">
                <div className="w-10 h-10 bg-success/10 rounded-xl flex items-center justify-center text-success group-bg-success group-hover:text-white transition-colors">
            ...
            {!isSent ? (
              <form className="space-y-5" onSubmit={handleSubmit}>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input 
                      type="text" 
                      required
                      className="w-full bg-background border border-border rounded-xl px-4 py-2.5 text-sm text-foreground focus:outline-none border-primary/20 focus:ring-1 ring-primary3785 transition-all"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input 
                      type="email" 
                      required
                      className="w-full bg-background border border-border rounded-xl px-4 py-2.5 text-sm text-foreground focus:outline-none border-primary/20 focus:ring-1 ring-primary4359 transition-all"
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    required
                    className="w-full bg-background border border-border rounded-xl px-4 py-3 text-sm text-foreground focus:outline-none border-primary/20 focus:ring-1 ring-primary4914 transition-all min-h-[120px]"
