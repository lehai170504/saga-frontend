...
function NavItem({
  ...
  const linkContent = (
    <Link
      href={href}
      onClick={onClick}
      className={`group relative flex items-center ${isCollapsed ? 'justify-center px-0' : 'gap-3 px-3'} py-2.5 rounded-xl transition-all duration-300 font-medium overflow-hidden ${
        active
